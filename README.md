...
Creating a React project with Typescript from scratch with Create React App
Using React concepts like Componentization, Props and State
Using the useState and useEffect hooks and understand how they were used in class components
Code with best practice concepts such as DRY (Don't repeat yourself) and SRP (Single Responsibility Principle)
